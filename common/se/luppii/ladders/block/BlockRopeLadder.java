...
public class BlockRopeLadder extends Block implements ITileEntityProvider {
	...
	public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4) {
		...
		return par1World.isBlockSolidOnSide(par2 - 1, par3, par4, EAST ) ||
				...
				par1World.getBlockId(par2, par3 + 1, par4) == LLadders.blockRopeLadder.blockID;
	}
    ...
    public int onBlockPlaced(World par1World, int par2, int par3, int par4, int par5, float par6, float par7, float par8, int par9) {
		...
		if (par1World.getBlockId(par2, par3 + 1, par4) == LLadders.blockRopeLadder.blockID) {
			return par1World.getBlockMetadata(par2, par3 + 1, par4);
		}
		if (par1World.getBlockId(par2, par3 - 1, par4) == LLadders.blockRopeLadder.blockID) {
			return par1World.getBlockMetadata(par2, par3 - 1, par4);
		}
		if ((par5 == 1 || par5 == 2) && par1World.isBlockSolidOnSide(par2, par3, par4 + 1, NORTH)) {
			
			j1 = 0;
		}
		if ((par5 == 1 || par5 == 3) && par1World.isBlockSolidOnSide(par2, par3, par4 - 1, SOUTH)) {
			
			j1 = 2;
		}
		if ((par5 == 1 || par5 == 4) && par1World.isBlockSolidOnSide(par2 + 1, par3, par4, WEST)) {
			
			j1 = 3;
		}
		if ((par5 == 1 || par5 == 5) && par1World.isBlockSolidOnSide(par2 - 1, par3, par4, EAST)) {
	...
	public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5) {
		...
		if (par1World.isBlockSolidOnSide(par2, par3 + 1, par4, SOUTH)) {
			
			flag = true;
		}
		if (metadata == 0 && par1World.isBlockSolidOnSide(par2, par3, par4 + 1, NORTH)) {
			
			flag = true;
		}
		if (metadata == 1 && par1World.isBlockSolidOnSide(par2 - 1, par3, par4, EAST)) {
			
			flag = true;
		}
		if (metadata == 2 && par1World.isBlockSolidOnSide(par2, par3, par4 - 1, SOUTH)) {
			
			flag = true;
		}
		if (metadata == 3 && par1World.isBlockSolidOnSide(par2 + 1, par3, par4, WEST)) {
