...
public class LLadders {
	...
	public void preInit(FMLPreInitializationEvent e) {
		...
		blockLadderDispenser = new BlockLadderDispenser(Config.blockLadderDispenser.getInt());
		blockRopeLadder = new BlockRopeLadder(Config.blockRopeLadder.getInt(), Config.ropeLadderLeftClick.getBoolean(true));
		blockSturdyLadder = new BlockSturdyLadder(Config.blockSturdyLadder.getInt(), Config.sturdyLadderLeftClick.getBoolean(true));
	...
	public void load(FMLInitializationEvent e) {
		...
		// Special eventhandler for falling players so climbing back side of ladders won't cause fall damage.
